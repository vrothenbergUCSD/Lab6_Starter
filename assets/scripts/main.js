...
const recipes = [
  ...
  //"https://introweb.tech/assets/json/ghostCookie.json",
  // "https://google.com",
];
...
async function fetchRecipes() {
  ...
  //console.log("after allRecipePromise");

  allRecipePromise.then(() => {
    console.log("Inside");
    if (Object.keys(recipeData).length === recipeData.length) {
      ...
      reject("Not able to fully populate the recipeData object");
    }
    return allRecipePromise;
  });
}
...
function createRecipeCards() {
  ...
  for (const recipeJSON in recipeData) {
